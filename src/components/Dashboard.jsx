...
const Dashboard = () => {
  return (
    ...
    <div className='flex h-screen w-full mt-12 xl:mt-0'>
       <div className='hidden xl:flex w-[22%] bg-[#ed1d24] h-full flex-col border-4 border-[#ed1d24]'>
       <DashboardNavbar />
       </div>

       <div className='w-full bg-gray-200 h-full'>
        <div className='shadow-lg w-full flex justify-center items-center h-[10%]'>
