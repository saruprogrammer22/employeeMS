...
const EmployeeLogin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    axios.post("http://localhost:8088/employee/employee_login", values)
    .then(result => {
    ...
    <div className='h-screen max-w-screen-xl mx-auto '>
      <Header />
        <div className='flex flex-col justify-center items-center w-full mt-12 xl:mt-28'>
            <div className='mt-8'>
                <h1 className='text-4xl font-semibold'>EMPLOYEE<span className='underline text-[#ed1d24]'>DEV</span></h1>
            </div>
